...
extern SYMBOL_HIDDEN GType netstatus_state_get_type (void);

#define NETSTATUS_TYPE_ERROR netstatus_error_get_type()
extern SYMBOL_HIDDEN GType netstatus_error_get_type (void);

#define NETSTATUS_TYPE_DEBUG_FLAGS netstatus_debug_flags_get_type()
extern SYMBOL_HIDDEN GType netstatus_debug_flags_get_type (void);
