...
static void config(Plugin *p, GtkWindow* parent)
{
    ...
    dialog = wtl_create_generic_config_dialog(_(plugin_class(p)->name),
            ...
            _("Charging color (high)"), &b->charging_color1, (GType)CONF_TYPE_RGBA,
            _("Charging color (low)"), &b->charging_color2, (GType)CONF_TYPE_RGBA,
            _("Discharging color (high)"), &b->discharging_color1, (GType)CONF_TYPE_RGBA,
            _("Discharging color (low)"), &b->discharging_color2, (GType)CONF_TYPE_RGBA,
